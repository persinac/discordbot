...
validateConfig(env_config_1.env_config);
const fs = require("fs");
const commandHandler = new command_handler_1.CommandHandler(env_config_1.env_config.prefix);
...
client.login(env_config_1.env_config.token);
